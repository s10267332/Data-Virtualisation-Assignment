...
# 🚲 Bike Retail Sales & Inventory Virtualization (Denodo)

A data virtualization project that integrates fragmented retail CSV datasets into a unified, business-ready analytics layer using Denodo. The system delivers real-time sales and inventory insights via a REST API for reporting and decision-making.
